  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <img
        ...
        alt="Gradiente azul"
        className="absolute top-4 right-[-15%] w-full h-full pointer-events-none select-none object-cover"
        draggable="false"
      />
      <img
      ...
      <div
        className="relative z-10 overflow-hidden w-full h-screen flex items-center justify-center pt-8 pb-2 px-4 md:pt-16 md:pb-4 md:px-12"
        style={{
      ...
      >
        <svg
          ...
          width="1890"
          height="850"
          viewBox="0 0 1890 850"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          {/* ...contenido SVG de public/vidrio.svg... */}
        </svg>

        {/* Solo el párrafo descriptivo duplicado debajo del vidrio */}
        <div className="absolute inset-0 z-0 flex flex-col justify-end pb-32 px-8">
        ...
        <nav className="absolute top-8 right-8 sm:right-12 md:right-16 flex items-center gap-4 sm:gap-6 md:gap-8">
        ...
        <div className="absolute bottom-32 left-0 w-full px-8">
          {/* Brand name */}
          <p className="text-white text-lg sm:text-xl font-medium italic mb-2 sm:mb-4">BrandHell.</p>
          ...
          {/* Description - responsive text size - exactamente igual que la versión duplicada */}
        ...
        <div className="absolute bottom-8 right-8 sm:right-12 md:right-16">
